...
from shapley.loader import FashionMnist, TinyImageNet, MNIST, CIFAR, PubFig, Flower, Spam
...
loader = Spam(num_train=args.num)
X_data, y_data, X_test_data, y_test_data = loader.prepare_data()
print("loader finished")
measure = KNN_Shapley()
print("measure finished")
# app = Summarization(X_data, y_data, X_test_data, y_test_data)
app = Poisoning(X_data, y_data, X_test_data, y_test_data)
# run and get result
app.run(measure, X_data, y_data, X_val, y_val)
